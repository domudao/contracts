...
module.exports = {
  ...
  testSign: async function (account,data ){
    try{
      console.log("This is chainid",await web3.eth.getChainId())
      console.log("The account ",account,"The data",data)
    signature = await account._signTypedData(JSON.stringify(data));
