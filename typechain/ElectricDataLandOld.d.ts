...
interface ElectricDataLandOldInterface extends ethers.utils.Interface {
  functions: {
...
export class ElectricDataLandOld extends Contract {
  ...
  interface: ElectricDataLandOldInterface;
